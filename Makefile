...
up:## up: starts all containers in the background without forcing build
...
## build_broker: builds the authentication binary as a linux executable
build_auth:
	@echo Building broker binary...
...
build_front:
	@echo Building broker binary...
	chdir .\front-end&& set GOOS=windows&& set CGO_ENABLED=0&& go build -o ${FRONT_END_BINARY} ./cmd/web
	@echo Done!
